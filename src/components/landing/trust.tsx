        ...
        <div className="grid lg:grid-cols-[1.1fr_1.3fr] gap-12 lg:gap-16 items-start">
          ...
          <Reveal direction="left" className="relative">
            ...
            <div className="mt-10 inline-flex items-stretch rounded-2xl border border-[#0F3D2E]/10 bg-white shadow-sm overflow-hidden">
              <div className="flex flex-col items-center justify-center gap-1 bg-gradient-to-br from-[#0F3D2E] to-[#0F3D2E] px-5 py-4 text-white">
                <p className="text-[9px] font-mono uppercase tracking-[0.2em] text-[#B5D33C]/80">Region</p>
                <p className="font-mono text-xl font-bold bg-gradient-to-br from-white to-[#B5D33C] bg-clip-text text-transparent">
                  EU · EEA
                </p>
              </div>
              <div className="flex flex-col justify-center gap-0.5 px-5 py-4">
                ...
                <p className="text-sm font-mono font-bold text-[#0F3D2E]">
                  EU-based processing
                </p>
              </div>
              <div className="flex items-center px-5 bg-[#FAFAF7]">
              ...
              return (
                <RevealItem key={p.label}>
                  <div className="group relative h-full rounded-2xl bg-white border border-[#0F3D2E]/10 p-6 md:p-7 shadow-sm hover:border-primary/30 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    ...
                    <p className="font-heading font-bold text-[15px] text-[#0F3D2E] tracking-tight mb-2">
                      {p.label}
                    </p>
                    ...
                    <div className="absolute inset-x-6 bottom-3 h-[2px] rounded-full bg-gradient-to-r from-[#7FD9AA] via-[#C8F25F] to-[#B5D33C] opacity-0 group-hover:opacity-100 transition-opacity" />
                  </div>
                </RevealItem>
              )
            })}
