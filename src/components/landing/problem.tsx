      ...
      <div className="relative mx-auto max-w-6xl px-4">
        ...
        <div className="grid md:grid-cols-2 gap-5 md:gap-6 max-w-5xl mx-auto">
            ...
            <div className="relative rounded-3xl border border-[#0F3D2E]/10 bg-white/80 backdrop-blur p-7 md:p-9 h-full shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-base font-heading font-semibold text-[#0F3D2E]/80">The 10-minute screen</p>
                </div>
              </div>
          ...
          <Reveal direction="right">
            <div className="relative rounded-3xl bg-gradient-to-br from-[#0F3D2E] via-[#0F3D2E] to-[#133F2E] p-7 md:p-9 h-full shadow-2xl shadow-[#0F3D2E]/30">
              ...
              <div className="absolute -top-3 left-8 inline-flex items-center gap-1.5 rounded-full bg-[#B5D33C] px-3 py-1 shadow-lg shadow-[#B5D33C]/30 z-10">
                <Sparkles className="h-3 w-3 text-[#0F3D2E]" />
                <span className="text-[10px] font-mono font-bold uppercase tracking-widest text-[#0F3D2E]">With Sam</span>
              </div>

              <div className="relative flex items-center gap-3 mb-6 mt-2">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#B5D33C]/15 ring-1 ring-[#B5D33C]/30">
                  <Check className="h-5 w-5 text-[#B5D33C] stroke-[2.5]" />
                </div>
                <div>
                  <p className="text-[10px] font-mono uppercase tracking-widest text-[#B5D33C]/80">Same framework</p>
