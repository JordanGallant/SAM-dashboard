  ...
  return (
    <div className="relative inline-flex items-center justify-center" style={{ width: size, height: size }}>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center leading-none">
        <CountUp to={score} className="text-3xl font-mono font-bold bg-gradient-to-br from-white to-[#B5D33C] bg-clip-text text-transparent tabular-nums" />
...
export function Comparison() {
  return (
    <section className="relative py-24 md:py-28 border-t overflow-hidden bg-gradient-to-br from-[#0F3D2E] via-[#0F3D2E] to-[#133F2E] text-white">
      {/* Ambient glows */}
      <div className="absolute -top-40 -left-40 h-96 w-96 rounded-full bg-primary/20 blur-3xl pointer-events-none" />
      <div className="absolute -bottom-40 -right-40 h-96 w-96 rounded-full bg-[#B5D33C]/10 blur-3xl pointer-events-none" />
      <div
      ...
      <div className="relative mx-auto max-w-6xl px-4">
        <Reveal className="max-w-3xl mx-auto text-center mb-16">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#B5D33C]/30 bg-[#B5D33C]/10 backdrop-blur px-3 py-1 text-[11px] font-mono uppercase tracking-widest text-[#B5D33C]">
            Where Sam sits
          </div>
        ...
        >
          ...
          <motion.div variants={item} className="order-2 md:order-1">
            ...
            <motion.ul variants={container} className="space-y-4">
              {samIs.map((b) => (
                <motion.li key={b} variants={item} className="flex items-start gap-3 text-white/90 text-[15px] md:text-base">
                  <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#B5D33C] shadow-md shadow-[#B5D33C]/30">
            ...
            >
              <p className="text-[10px] font-mono uppercase tracking-widest text-[#B5D33C]/70 mb-3">
                Position statement
              </p>
          ...
          <motion.div variants={item} className="relative order-1 md:order-2">
            <div className="relative rounded-[2rem] bg-gradient-to-br from-[#B5D33C] via-[#C8F25F] to-[#9ED44D] p-5 md:p-7 shadow-2xl shadow-black/50">
              {/* Inner shines & grain */}
              ...
              {/* Memo "passport" card */}
              <div className="relative rounded-2xl bg-gradient-to-br from-[#0F3D2E] via-[#0F3D2E] to-[#133F2E] p-5 md:p-6 shadow-2xl shadow-black/50 ring-1 ring-white/10 overflow-hidden">
                <div
                ...
                <div className="relative flex items-center justify-between mb-5">
                  <div className="flex items-center gap-2">
                    <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#B5D33C]/20 ring-1 ring-[#B5D33C]/30">
                      <span className="text-xs font-mono font-bold text-[#B5D33C]">S</span>
                    </div>
                    <div>
                  ...
                  <span className="text-[9px] font-mono uppercase tracking-widest text-[#B5D33C]/70">#0042</span>
                </div>

                <div className="relative flex items-center gap-5 mb-5">
                  <RingGauge score={82} size={112} />
                  <div className="flex-1">
                    <div className="inline-flex items-center rounded-md bg-[#B5D33C]/15 ring-1 ring-[#B5D33C]/30 px-2.5 py-1 mb-2">
                      <span className="text-xs font-bold font-heading text-[#B5D33C]">HIGH PRIORITY</span>
                    </div>
                ...
                <div className="relative space-y-2 pt-4 border-t border-white/10">
                  <p className="text-[9px] font-mono uppercase tracking-widest text-[#B5D33C]/70 mb-2">Domain scores</p>
                  {domains.map((d, i) => {
                    const Icon = d.icon
                    return (
                      <div key={d.domain} className="grid grid-cols-[1rem_4.5rem_1fr_2rem] items-center gap-2.5 text-[10px] font-mono">
                        ...
                        <div className="h-1 rounded-full bg-white/5 overflow-hidden">
                          <AnimatedBar
                            percent={d.score}
                            delay={0.5 + i * 0.08}
                            className="h-full rounded-full bg-gradient-to-r from-[#7FD9AA] via-[#C8F25F] to-[#B5D33C]"
                          />
                        </div>
                        <CountUp to={d.score} duration={0.9} className="font-semibold text-[#B5D33C] text-right tabular-nums" />
                      </div>
                    )
                  })}
                </div>
              ...
              >
                <div className="rounded-full bg-[#0F3D2E] shadow-xl ring-1 ring-[#B5D33C]/20 px-3.5 py-2 flex items-center gap-2">
                  <Scale className="h-3.5 w-3.5 text-[#B5D33C]" />
