...
const audiences = [
  ...
  {
    icon: Network,
    label: "For syndicates, family offices & teams",
    ...
    body: "Your deal notes live across three tools and two heads. Sam produces a consistent assessment per deal that your team can compare, discuss and reference.",
    href: "/how-it-works",
    featured: true,
  },
  {
