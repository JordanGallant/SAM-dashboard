...
/**
 * Variant 2 — Scorecard Overview.
 * Kuanta-style layout with Sam palette. Sticky left rail carries the score
 * gauge + radar + compact scorecard. Right pane reads as a stack of domain
 * cards (icon + title + key finding + domain-level strengths/weaknesses).
 * Tinted callout strip at the bottom for Highlights / Risks / Next Steps.
 */
