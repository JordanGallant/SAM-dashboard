            ...
            <Reveal direction="right">
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-6 mt-2">
                  <div
                    className="flex h-10 w-10 items-center justify-center rounded-xl"
                    style={{ background: "rgba(215,254,63,0.10)", border: "1px solid rgba(215,254,63,0.25)" }}
                  >
                  ...
                  {[
                    ...
                    <li key={b} className="flex items-start gap-2.5 text-[13.5px] text-white/80 leading-snug">
                      <span
                        ...
                        style={{ background: "rgba(215,254,63,0.12)", border: "1px solid rgba(215,254,63,0.30)" }}
                      >
