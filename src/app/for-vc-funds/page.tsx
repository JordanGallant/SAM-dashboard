...
import { ArrowRight, Check, Building2, X, Sparkles } from "lucide-react"
...
const currentState = [
  ...
  "Every analyst screens slightly differently — memos aren't comparable",
                ...
                <div className="relative h-full rounded-3xl border border-[#0F3D2E]/10 bg-white/80 backdrop-blur p-7 md:p-9 shadow-sm">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-base font-heading font-semibold text-[#0A2E22]/80">The misallocation</p>
                    </div>
                  </div>
              ...
              <Reveal direction="right">
                <div className="relative h-full rounded-3xl bg-gradient-to-br from-[#0A2E22] via-[#0F3D2E] to-[#133F2E] p-7 md:p-9 shadow-2xl shadow-[#0F3D2E]/30">
                  ...
                  <div className="relative flex items-center gap-3 mb-6 mt-2">
                    ...
                    <div>
                      <p className="text-[10px] font-mono uppercase tracking-widest text-[#D4FF6B]/80">Triage layer</p>
                      <p className="text-base font-heading font-semibold text-white">Same framework, every analyst</p>
                    </div>
                  </div>
                  <p className="relative text-[15px] text-white/80 leading-relaxed">
                    Sam produces a consistent first-pass memo for every deck your team forwards. Same framework, same structure, same scoring rubric. Your associates spend their time on the deals that warrant deeper work, and your IC reviews a consistent document regardless of who handled intake. The standardisation itself is the product.
                  </p>
                </div>
              </Reveal>
            </div>
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#0A2E22] via-[#0F3D2E] to-[#1A6B47] px-8 py-16 md:px-16 md:py-20 shadow-2xl shadow-[#0F3D2E]/30">
              ...
              <div className="relative text-center">
                ...
                <h2 className="mt-5 text-3xl md:text-4xl lg:text-5xl font-bold font-heading tracking-tight text-white">
                  ...
                  <br />
                  <span className="bg-gradient-to-r from-[#D4FF6B] to-[#C8F25F] bg-clip-text text-transparent">
                    not a sales rep.
                  </span>
                </h2>
